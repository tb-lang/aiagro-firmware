/**
 * OLIMPIA WiFi - projeto independente (separado do laranja_v44L em 06/jun)
...
const char* OTA_URL_VERSION =
  "https://raw.githubusercontent.com/tb-lang/aiagro-firmware/main/olimpia_wifi/VERSION";
const String OTA_URL_BINARIO =
  String("https://raw.githubusercontent.com/tb-lang/aiagro-firmware/main/olimpia_wifi/builds/")
  + DEVICE_CODIGO + ".bin";
