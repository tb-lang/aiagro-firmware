/**
 * UNIUBE CAFE WiFi - projeto independente (virada LoRa -> WiFi em 27/jul)
 * Base: laranja_wifi l2 (copia IDENTICA — mesma logica e sequencia)
 * + OTA via GitHub (pasta propria cafe_wifi/)
 ...
 *   (o Cafe NAO tem pluviometro instalado — GPIO 25 fica em pullup, pulsos=0)
 *
...
// ====== Config por dispositivo (defaults; sobrescritos por build_flags) ======
  ...
  #define DEVICE_CODIGO "UNIUBE_WIFI_CAFE"
#endif
#ifndef DISP_ID
  #define DISP_ID "92c33471-df32-487e-a895-f044fa280def"
#endif
#ifndef WIFI_SSID
...
const char* OTA_URL_VERSION =
  "https://raw.githubusercontent.com/tb-lang/aiagro-firmware/main/cafe_wifi/VERSION";
const String OTA_URL_BINARIO =
  String("https://raw.githubusercontent.com/tb-lang/aiagro-firmware/main/cafe_wifi/builds/")
  + DEVICE_CODIGO + ".bin";
...
#define NUMERO_DE_ENVIOS       10   // MODO TESTE (c1): 10 leituras seguidas p/ ver se batem
...
bool conectarWiFi(bool forcar = false) {
  ...
  // Cafe Uniube) continuam com tentativa unica.
...
void setup() {
  ...
  if (wakeNormal || ehHoraEnvio) {
    ...
    for (int i = 0; i < NUMERO_DE_ENVIOS; i++) {
      ...
      if (i < NUMERO_DE_ENVIOS - 1) delay(15000);   // MODO TESTE (c1): 15s entre leituras
    }
